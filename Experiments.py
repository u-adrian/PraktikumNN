...
def main():
    # unique_name = Trainer.train(device="GPU", generator="small_gan", discriminator="small_gan",
    ...
    # Evaluator.create_images(device="GPU", generator="small_gan", noise_size="20",
    ...
    model_path = f'./models/{unique_name}/gan_latest'
    output_path = f'./data/{unique_name}/results'
    Evaluator.create_images(device="GPU", generator="res_net_depth1", noise_size="20", model_path=model_path,
